...
7. If you see an `.msi` file, double-click it and follow the setup steps.
...
1. Open the folder that holds the app.
...
3. Replace the old folder or install the new version.
4. Open the newest app file.
...
### Where should I save the download?
...
5. Keep the folder for later use